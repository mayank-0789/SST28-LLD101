...
/**
 * Immutable incident ticket. Use {@link Builder} to construct instances.
 * Fields are private final; no setters exist.
 * The tags list is defensively copied and wrapped in an unmodifiable view.
 * All validation is centralized in {@link Builder#build()}.
 */
public final class IncidentTicket {
    ...
    public List<String> getTags() { return tags; } // safe: returns unmodifiable view
   ...
   public static final class Builder {
        ...
        public Builder from(IncidentTicket t) {
            ...
            this.tags = new ArrayList<>(t.tags); // defensive copy
